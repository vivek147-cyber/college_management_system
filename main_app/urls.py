...
urlpatterns = [
    ...
    path('staff/home/post/', staff_views.post_list, name='staff_post_list'),
    path('staff/home/post/<int:pk>/', staff_views.post_detail, name='staff_post_detail'),
    path('staff/home/post/new/', staff_views.new_post, name='staff_new_post'),
    path('staff/home/tag/new/', staff_views.new_tag, name='staff_new_tag'),
    path('staff/home/post/<int:pk>/reply/', staff_views.new_reply, name='staff_new_reply'),
    ...
    path('student/home/post/', student_views.post_list, name='post_list'),
    path('student/home/post/<int:pk>/', student_views.post_detail, name='post_detail'),
    path('student/home/post/<int:pk>/reply/', student_views.new_reply, name='new_reply'),
